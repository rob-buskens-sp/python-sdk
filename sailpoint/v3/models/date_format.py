...
class DateFormat(BaseModel):
    ...
    DateFormat
    """ # noqa: E501
    input_format: Optional[DateFormatInputFormat] = Field(default=None, alias="inputFormat")
    output_format: Optional[DateFormatOutputFormat] = Field(default=None, alias="outputFormat")
    ...
    __properties: ClassVar[List[str]] = ["inputFormat", "outputFormat", "requiresPeriodicRefresh", "input"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of input_format
        if self.input_format:
            _dict['inputFormat'] = self.input_format.to_dict()
        # override the default output from pydantic by calling `to_dict()` of output_format
        if self.output_format:
            _dict['outputFormat'] = self.output_format.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "inputFormat": DateFormatInputFormat.from_dict(obj.get("inputFormat")) if obj.get("inputFormat") is not None else None,
            "outputFormat": DateFormatOutputFormat.from_dict(obj.get("outputFormat")) if obj.get("outputFormat") is not None else None,
