...
class Static(BaseModel):
    ...
    Static
    """ # noqa: E501
    values: StrictStr = Field(description="This must evaluate to a JSON string, either through a fixed value or through conditional logic using the Apache Velocity Template Language.")
    ...
    __properties: ClassVar[List[str]] = ["values", "requiresPeriodicRefresh"]
