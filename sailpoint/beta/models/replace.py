...
class Replace(BaseModel):
    ...
    Replace
    """ # noqa: E501
    regex: StrictStr = Field(description="This can be a string or a regex pattern in which you want to replace.")
    replacement: StrictStr = Field(description="This is the replacement string that should be substituded wherever the string or pattern is found.")
    ...
    __properties: ClassVar[List[str]] = ["regex", "replacement", "requiresPeriodicRefresh", "input"]
