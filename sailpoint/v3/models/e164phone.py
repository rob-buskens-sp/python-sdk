...
class E164phone(BaseModel):
    """
    E164phone
    """ # noqa: E501
    default_region: Optional[StrictStr] = Field(default=None, description="This is an optional attribute that can be used to define the region of the phone number to format into.   If defaultRegion is not provided, it will take US as the default country.   The format of the country code should be in [ISO 3166-1 alpha-2 format](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) ", alias="defaultRegion")
    ...
    __properties: ClassVar[List[str]] = ["defaultRegion", "requiresPeriodicRefresh", "input"]
