...
class ReplaceAll(BaseModel):
    ...
    ReplaceAll
    """ # noqa: E501
    table: Dict[str, Any] = Field(description="An attribute of key-value pairs. Each pair identifies the pattern to search for as its key, and the replacement string as its value.")
