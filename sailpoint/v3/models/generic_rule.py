...
class GenericRule(BaseModel):
    ...
    GenericRule
    """ # noqa: E501
    name: StrictStr = Field(description="This is the name of the Generic rule that needs to be invoked by the transform")
    ...
    __properties: ClassVar[List[str]] = ["name", "requiresPeriodicRefresh"]
