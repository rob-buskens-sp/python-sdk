...
class Conditional(BaseModel):
    ...
    Conditional
    """ # noqa: E501
    expression: StrictStr = Field(description="A comparison statement that follows the structure of `ValueA eq ValueB` where `ValueA` and `ValueB` are static strings or outputs of other transforms.   The `eq` operator is the only valid comparison")
    ...
    __properties: ClassVar[List[str]] = ["expression", "positiveCondition", "negativeCondition", "requiresPeriodicRefresh", "input"]
