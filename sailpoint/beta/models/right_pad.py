...
class RightPad(BaseModel):
    """
    RightPad
    """ # noqa: E501
    length: StrictStr = Field(description="An integer value for the desired length of the final output string")
    padding: Optional[StrictStr] = Field(default=None, description="A string value representing the character that the incoming data should be padded with to get to the desired length   If not provided, the transform will default to a single space (\" \") character for padding ")
    ...
    __properties: ClassVar[List[str]] = ["length", "padding", "requiresPeriodicRefresh", "input"]
