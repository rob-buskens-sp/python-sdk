...
class IndexOf(BaseModel):
    """
    IndexOf
    """ # noqa: E501
    substring: StrictStr = Field(description="A substring to search for, searches the entire calling string, and returns the index of the first occurrence of the specified substring.")
    ...
    __properties: ClassVar[List[str]] = ["substring", "requiresPeriodicRefresh", "input"]
