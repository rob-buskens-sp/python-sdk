...
class AggregationResult(BaseModel):
    ...
    hits: Optional[List[SearchDocument]] = Field(default=None, description="The results of the aggregation search query. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hits": [SearchDocument.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None
        })
        return _obj
