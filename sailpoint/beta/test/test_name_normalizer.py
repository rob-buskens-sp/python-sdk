...
class TestNameNormalizer(unittest.TestCase):
    """NameNormalizer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NameNormalizer:
        """Test NameNormalizer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NameNormalizer`
        """
        model = NameNormalizer()
        if include_optional:
